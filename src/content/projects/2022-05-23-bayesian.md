...
github: "https://github.com/Roudranil/Bayesian-analysis-of-efficacy-of-the-ChAdOx1-nCoV-19-AZD1222-vaccine"
---
...
In order to perform Bayesian inference, we impose prior distributions on the incidence rate of infection in the 
...
Using the posterior density of vaccine efficacy we can compute the predicted vaccine efficacy, and also the 
...
From the results of our models, we can conclude that a Bayesian analysis of vaccine clinical trials 
data is also a viable method to compute the efficacy.

## Links

- [presentation](/dissertation/presentation.pdf)
- [full text of the project paper](/dissertation/paper.pdf)
