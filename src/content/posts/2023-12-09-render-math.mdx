...
description: "A step-by-step guide to rendering math in Astro markdown and MDX with remark-math, rehype-katex, and KaTeX, including how to self-host KaTeX's stylesheet and fonts and swap in Computer Modern for a LaTeX-like look."
